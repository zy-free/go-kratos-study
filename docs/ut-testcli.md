...
*这个是testing/lich的二进制工具版本（Go请直接使用库版本：go-kartos-study/pkg/testing/lich)*
...
```Go
import "go-kartos-study/pkg/testing/lich"
```
...
- Step1. 在 Dao|Service 层中的 TestMain 单测主入口中，import  "go-kartos-study/pkg/testing/lich" 引入testcli工具的go库版本。
...
import (
    ...
    "go-kartos-study/pkg/testing/lich"
 )
