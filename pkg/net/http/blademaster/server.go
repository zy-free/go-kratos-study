...
import (
	...
	"go-kartos-study/pkg/conf/dsn"
	"go-kartos-study/pkg/log"
	"go-kartos-study/pkg/net/criticality"
	"go-kartos-study/pkg/net/ip"
...
func DefaultServer(conf *ServerConfig) *Engine {
	...
	engine.Use(Recovery(), Trace(), CORS(), Logger(), MaxByte(1*1024*1024), Breaker(), NewRateLimiter(nil).Limit())
	return engine
}
