...
import (
	...
	"go-kartos-study/pkg/net/http/blademaster/binding"
	"go-kartos-study/pkg/net/http/blademaster/render"
...
// CSV serializes the given struct as CSV into the response body.
// It also sets the Content-Type as "application/csv".
func (c *Context) CSV(csv CSVMsg, err error) {
	code := http.StatusOK
	c.Error = err
