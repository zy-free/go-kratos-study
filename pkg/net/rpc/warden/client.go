...
import (
	...
	"go-kartos-study/pkg/net/rpc/warden/resolver"
	...
	"go-kartos-study/pkg/conf/flagvar"
	...
	"go-kartos-study/pkg/net/rpc/warden/balancer/p2c"
	"go-kartos-study/pkg/net/rpc/warden/internal/status"
...
func init() {
	...
	c,err := etcd.New(&clientv3.Config{Endpoints:[]string{"127.0.0.1:2379"}})
	if err != nil{
		log.Error("warden client New err:",err)
	}
	resolver.Register(c)
}
